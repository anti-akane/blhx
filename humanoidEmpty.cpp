...
humanoidEmpty::humanoidEmpty(int HP,int power,int torp,int speed,int shootcd,int torpcd,QPixmap Tachie,QPoint location)
    :emptyWarShip(HP,power,torp,speed,shootcd,torpcd,Tachie,location) {
