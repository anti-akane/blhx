...
# Project:  blhx.pro
# Template: app
# Command: C:\Qt\5.9.9\mingw53_32\bin\qmake.exe -o Makefile blhx.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
#############################################################################
...
Makefile: blhx.pro ../mkspecs/win32-g++/qmake.conf ../mkspecs/features/spec_pre.prf \
		../mkspecs/qdevice.pri \
		...
		../lib/Qt5Gui.prl \
		../lib/Qt5Core.prl
	$(QMAKE) -o Makefile blhx.pro -spec win32-g++ "CONFIG+=debug" "CONFIG+=qml_debug"
